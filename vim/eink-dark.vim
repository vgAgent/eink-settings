...
hi Constant        guifg=#cccccc               ctermfg=15
hi String          guifg=#aaaaaa               ctermfg=7   gui=italic    cterm=italic
hi Number          guifg=#cccccc               ctermfg=15
hi Boolean         guifg=#ffffff               ctermfg=15  gui=bold      cterm=bold
...
hi Special         guifg=#bbbbbb               ctermfg=7
...
hi CursorLineNr    guifg=#ffffff guibg=#111111 ctermfg=15  ctermbg=8     gui=bold  cterm=bold
hi CursorColumn    guibg=#111111               ctermbg=8
hi ColorColumn     guibg=#111111               ctermbg=8
hi SignColumn      guifg=#555555 guibg=#000000 ctermfg=8   ctermbg=0
hi FoldColumn      guifg=#555555 guibg=#000000 ctermfg=8   ctermbg=0
hi Folded          guifg=#888888 guibg=#111111 ctermfg=8   ctermbg=8     gui=italic cterm=italic
...
hi StatusLineNC    guifg=#000000 guibg=#555555 ctermfg=0   ctermbg=8
hi TabLine         guifg=#ffffff guibg=#333333 ctermfg=15  ctermbg=8
hi TabLineFill     guifg=#ffffff guibg=#333333 ctermfg=15  ctermbg=8
...
hi Directory       guifg=#ffffff               ctermfg=15  gui=bold      cterm=bold
...
hi Conceal         guifg=#555555 guibg=#000000 ctermfg=8   ctermbg=0
hi SpellBad        guifg=#ffffff               ctermfg=15  gui=undercurl cterm=underline
hi SpellCap        guifg=#ffffff               ctermfg=15  gui=undercurl cterm=underline
hi DiffAdd         guifg=#ffffff guibg=#222222 ctermfg=15  ctermbg=8
hi DiffDelete      guifg=#555555 guibg=#111111 ctermfg=8   ctermbg=8
